...
public static class Options
{
	...
	public static readonly Option<FileInfo> File = new("--file")
	{
	...
	{
		Description = "The working directory to use when spawning the PowerServe server if needed.",
	...
	{
		Description = "The named pipe to use. The server will start here if not already running. Defaults to PowerServe-{username}.",
	...
	{
		Description = "The maximum depth for JSON serialization of PowerShell objects. Defaults to 2.",
